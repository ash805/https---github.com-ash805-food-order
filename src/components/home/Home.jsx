      ...
      <div className={classes.container}>
        ...
        <div className={classes.delivery}>
          <div className={classes.titles}>
            ...
            <h2 className={classes.deliverTitle}>Always On Time For You</h2>
          </div>
          <div className={classes.deliveryInfos}>
            <div className={classes.deliveryInfo}>
              <img src={illustration1} alt="" className={classes.firstImg}></img>
              <h3>Our delivery Guy is always on time</h3>
            </div>
            <div className={classes.deliveryInfo}>
              <img src={illustration2} alt=" " className = {classes.secondImg}></img>
              <h3> He works very hard</h3>
            </div>
            <div className={classes.deliveryInfo}>
              <img src={illustration3} alt=" " className = {classes.thirdImg}></img>
